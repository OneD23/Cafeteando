      ...
      <ScrollView refreshControl={<RefreshControl refreshing={refreshing} onRefresh={loadData} />} contentContainerStyle={styles.content}>
        ...
        {activeTab === 'diario' && (
          <View style={styles.sectionCard}>
            ...
            <View style={styles.balanceRow}><Text>Debe: {money(journal?.totalDebit)}</Text><Text>Haber: {money(journal?.totalCredit)}</Text><Text style={journal?.status === 'cuadrado' ? styles.ok : styles.warning}>{journal?.status || 'sin datos'} · Dif. {money(journal?.difference)}</Text></View>
...
const styles = StyleSheet.create({
  ...
  header: { paddingHorizontal: 18, paddingVertical: 16, backgroundColor: '#2c1810', flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' },
  eyebrow: { color: '#d4a574', fontSize: 12, fontWeight: '700', textTransform: 'uppercase', letterSpacing: 1 },
  title: { color: '#fff7ed', fontSize: 30, fontWeight: '900' },
  printButton: { flexDirection: 'row', gap: 6, backgroundColor: '#7c4a2d', borderRadius: 12, paddingHorizontal: 14, paddingVertical: 10, alignItems: 'center' },
  printButtonText: { color: '#fff', fontWeight: '800' },
  tabs: { backgroundColor: '#fff7ed', paddingVertical: 10, borderBottomWidth: 1, borderBottomColor: '#ead7c2' },
  tab: { flexDirection: 'row', gap: 6, alignItems: 'center', paddingHorizontal: 14, paddingVertical: 9, marginHorizontal: 5, borderRadius: 999, borderWidth: 1, borderColor: '#d9c2aa' },
  activeTab: { backgroundColor: '#7c4a2d', borderColor: '#7c4a2d' },
  tabText: { color: '#7c4a2d', fontWeight: '800' },
  activeTabText: { color: '#fff7ed' },
  content: { padding: 14, paddingBottom: 40 },
  filterCard: { backgroundColor: '#fff', borderRadius: 18, padding: 14, marginBottom: 14, borderWidth: 1, borderColor: '#ead7c2' },
  filterGrid: { gap: 10 },
  input: { backgroundColor: '#fffaf5', borderWidth: 1, borderColor: '#e7d5c3', borderRadius: 12, paddingHorizontal: 12, paddingVertical: 11, color: '#2c1810', marginBottom: 8 },
  sectionCard: { backgroundColor: '#fff', borderRadius: 18, padding: 14, marginBottom: 14, borderWidth: 1, borderColor: '#ead7c2' },
  sectionHeader: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: 10 },
  sectionTitle: { color: '#2c1810', fontSize: 18, fontWeight: '900', marginBottom: 10 },
  kpiGrid: { flexDirection: 'row', flexWrap: 'wrap', gap: 10 },
  kpiCard: { width: '48%', backgroundColor: '#fff', borderRadius: 18, padding: 14, borderWidth: 1, borderColor: '#ead7c2', minHeight: 114 },
  kpiLabel: { color: '#7b8794', fontSize: 12, fontWeight: '700', marginTop: 8 },
  kpiValue: { color: '#1f2933', fontSize: 20, fontWeight: '900', marginTop: 4 },
  chipRow: { flexDirection: 'row', flexWrap: 'wrap', gap: 8, marginVertical: 8 },
  chip: { borderWidth: 1, borderColor: '#d9c2aa', borderRadius: 999, paddingHorizontal: 10, paddingVertical: 7, backgroundColor: '#fffaf5' },
  chipActive: { backgroundColor: '#ead7c2', borderColor: '#7c4a2d' },
  chipText: { color: '#5b341f', fontWeight: '700', fontSize: 12 },
  primaryButton: { backgroundColor: '#5b341f', borderRadius: 12, padding: 13, alignItems: 'center', marginTop: 6 },
  dangerButton: { backgroundColor: '#b91c1c', borderRadius: 12, padding: 13, alignItems: 'center', marginTop: 6 },
  primaryButtonText: { color: '#fff7ed', fontWeight: '900' },
  secondaryButton: { borderWidth: 1, borderColor: '#7c4a2d', borderRadius: 12, padding: 13, alignItems: 'center', marginTop: 6 },
  secondaryButtonText: { color: '#7c4a2d', fontWeight: '900' },
  tableRow: { flexDirection: 'row', gap: 10, alignItems: 'center', justifyContent: 'space-between', paddingVertical: 12, borderBottomWidth: 1, borderBottomColor: '#edf2f7' },
  tableMain: { flex: 1 },
  rowTitle: { color: '#1f2933', fontWeight: '900', fontSize: 14 },
  rowMeta: { color: '#64748b', fontSize: 12, marginTop: 3 },
  actions: { alignItems: 'flex-end', gap: 3 },
  amount: { color: '#047857', fontWeight: '900' },
  status: { color: '#047857', fontWeight: '800', textTransform: 'uppercase', fontSize: 11 },
  statusDanger: { color: '#b91c1c' },
  link: { color: '#2563eb', fontWeight: '900' },
  dangerLink: { color: '#b91c1c', fontWeight: '900' },
  emptyText: { color: '#64748b', textAlign: 'center', padding: 22 },
  balanceRow: { backgroundColor: '#fff7ed', borderRadius: 12, padding: 12, gap: 6, marginBottom: 8 },
  ok: { color: '#047857', fontWeight: '900' },
  warning: { color: '#b45309', fontWeight: '900' },
  debit: { color: '#b91c1c', fontWeight: '800', textAlign: 'right' },
  credit: { color: '#047857', fontWeight: '800', textAlign: 'right' },
  totalStrip: { flexDirection: 'row', flexWrap: 'wrap', gap: 8, marginBottom: 8 },
  totalText: { backgroundColor: '#f8fafc', borderRadius: 10, paddingHorizontal: 9, paddingVertical: 6, color: '#334155', fontWeight: '800' },
  cashBanner: { backgroundColor: '#2c1810', borderRadius: 16, padding: 14, marginBottom: 10 },
  cashBannerTitle: { color: '#fff7ed', fontSize: 18, fontWeight: '900' },
  cashBannerText: { color: '#d4a574', marginTop: 4, fontWeight: '700' },
  reportGrid: { flexDirection: 'row', flexWrap: 'wrap', gap: 10 },
  reportCard: { width: '48%', backgroundColor: '#fffaf5', borderRadius: 14, padding: 12, borderWidth: 1, borderColor: '#ead7c2' },
});
